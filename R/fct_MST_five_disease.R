...
#'
#' @export
MST_five_disease <- function(data_expresion1 = NULL,
                             data_expresion2 = NULL, 
                             data_expresion3 = NULL,
                             data_expresion4 = NULL,
                             data_expresion5 = NULL, 
                             data_gene = NULL) 
  {
  ...
  geo.gender99039 = geo.gender99039[
                    order(geo.gender99039$disease.state),]
  
  geo.GenderMale19587 <- data_expresion5
  geo.gender19587 <- geo.GenderMale19587
  geo.gender19587 = geo.gender19587[
                    order(geo.gender19587$disease.state),]
  ...
  MST_Front10_46681_Asymp <- geo.final_46681_Asymp[,c("disease.state",
                                                      ResultsMeta4D$Gene)]
  MST_Front10_GSE99039 <- geo.gender99039[,c("disease.state",
                                             ResultsMeta4D$Gene)]
  MST_Front10_GSE19587 <- geo.gender19587[,c("disease.state",
                                             ResultsMeta4D$Gene)]
  ...
  ContImpGenes_PD <- MST_Front10_GSE99039[
                    MST_Front10_GSE99039$disease.state == "control",]
  ...
  DiseaseImpGenes_PD <-  MST_Front10_GSE99039[
                         MST_Front10_GSE99039$disease.state == "disease",]
  ...
  ContImpGenes_PD1 <- MST_Front10_GSE19587[
                      MST_Front10_GSE19587$disease.state == "control",]
  ...
  DiseaseImpGenes_PD1 <-  MST_Front10_GSE19587[
                          MST_Front10_GSE19587$disease.state == "disease",]
  ...
  dfFem_PD <- data.frame(t(matrix(unlist(p), 
                                  nrow=length(p), 
                                  byrow=T
                                  )
                           )
  ...
  dfFem_PD1 <- data.frame(t(matrix(unlist(r), 
                                   nrow=length(r),
                                   byrow=T)
                            )
                          )
